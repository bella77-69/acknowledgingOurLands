  ...
  return (
    ...
    <div className="container mx-auto px-6 lg:px-12">
      ...
      <div className="text-center mb-10">
        ...
        <p className="mt-4 text-gray-600 dark:text-gray-300">
          Learn about the Indigenous territories you are on by identifying your location and exploring the history of the land.
        </p>
      </div>
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="relative space-y-8 lg:pr-8">
          ...
          <div className="bg-customWhite dark:bg-gray-900 shadow rounded-lg p-6 relative z-10">
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Your Current Location</h2>
            {latitude && longitude ? (
          ...
          {/* Indigenous Lands */}
          <div className="bg-customWhite dark:bg-gray-900 shadow rounded-lg p-6 relative z-10">
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Indigenous Lands</h2>
            {indigenousLands.length > 0 ? (
              indigenousLands.map((land, index) => (
                <div key={index} className="mt-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      {land?.properties?.description || "No description available"}
                    </a>
                  </p>
                </div>
              ))
