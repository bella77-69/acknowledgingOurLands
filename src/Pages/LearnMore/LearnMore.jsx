        ...
        <div className="text-center p-4">
          <a
            className="inline-flex justify-center items-center gap-x-2 text-center
             bg-customNav text-customWhite font-bold  sm:text-sm md:text-base
            rounded-lg px-6 py-2 text-sm  hover:bg-buttonHover hover:text-customWhite transition ease-in-out duration-300 md:px-6"
            href="/contact"
          >
            Contact Us
            <svg
