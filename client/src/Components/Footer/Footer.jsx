...
function Footer() {
  ...
  const navLinks = [...baseLinks, ...(isLoggedIn ? authenticatedLinks : [])];
    ...
    <footer className="bg-customNav text-customWhite">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-md text-center leading-relaxed">
          &copy; {currentYear} Acknowledging Our Lands. All rights reserved.
        </p>
        ...
        <p className="mx-auto mt-6 max-w-xl text-center leading-relaxed">
          ...
          <a
            className="text-amber-400 underline decoration-2 underline-offset-4
             focus-visible:outline-none focus-visible:ring-2
             focus-visible:ring-customWhite focus-visible:ring-offset-2
             dark:focus-visible:ring-offset-darkBackground rounded"
